...
I am no great visionary thinker, I am no brilliant engineer, I am a new grad looking for my first job. I believe I am qualified for most new grad roles being posted out there. I have worked with Python, C++, Java, I have productionized them, I know git, I know good coding and engineering practices, I know how to write git commits, etc. etc. As such, maybe I was naive in thinking that I just need to figure out how to tailor to every JD in a way to best represent my experience. That this is not an impossible problem, and simply a problem looking for the right architecture. So I told myself a white lie that I will solve every single one of these bottlenecks, for myself, so that I can make my job search more efficient. It wasn't easy. 18-hour days for 14 days straight.
